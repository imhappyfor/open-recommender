...
## Repository contributor tooling

The repository also contains project-local Copilot assets under `.github/`, with a runtime-compatible skill mirror under `.agents/skills/`:
...
They exist to help contributors and coding agents work consistently with the project's current direction. They are not part of the runtime API or ORF protocol implementation.
